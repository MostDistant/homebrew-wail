...
class Wail < Formula
  ...
  url "https://github.com/MostDistant/WAIL/releases/download/v5.0.0/wail-5.0.0-src.tar.gz"
  sha256 "bac4a048a5a75eb344145897c9e0e32990d610c4de9b8a93329236d53a9d404f"
  license "MIT"
